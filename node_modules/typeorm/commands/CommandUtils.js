 ...
 */
class CommandUtils {
    static loadDataSource(dataSourceFilePath) {
        let dataSourceFileExports;
        try {
            dataSourceFileExports = require(dataSourceFilePath);
        }
        catch (err) {
            throw new Error(`Invalid file path given: "${dataSourceFilePath}". File must contain a TypeScript / JavaScript code and export a DataSource instance.`);
        }
